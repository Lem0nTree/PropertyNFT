...
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
    ...
    * and querying based on certain attributes like launchpadID. It also provides role-based access control for various operations.
    */
contract PropertyNFT is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    */
    struct Property {
        ...
        uint launchpadID; // id of the launchpad that sold the property
    ...
    mapping(uint => uint256[]) public launchpadIDToTokenIds; // Mapping of launchpad ID to an array of token IDs
    ...
    * @param launchpadID - id of the launchpad that sold the property.
    ...
    */
    function mintProperty(
        ...
        launchpadIDToTokenIds[launchpadID].push(newTokenId);
    ...
    /**
    * @dev Fetches all tokens associated with a particular launchpadID.
    * @param _launchpadID - the ID of the launchpad to query.
    * @return A list of token IDs associated with the provided launchpadID.
    */
    function getTokensByLaunchpadID(uint _launchpadID) public view returns (uint256[] memory) {
        return launchpadIDToTokenIds[_launchpadID];
    }
    ...
    *
    * @param launchpadID The ID of the launchpad for which rewards are to be distributed.
    ...
    */
    function distributeRewards(uint launchpadID, uint amount, address TokenAddress) external onlyOperator {
        ...
        uint256[] memory tokenIDs = getTokensByLaunchpadID(launchpadID);
